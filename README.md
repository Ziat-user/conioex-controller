...
*   一部のコントローラーでは受け取る値が違うようです。
      *   RLbumperに深さの判定がある場合、`PJ_ZPOS`に割り当てられ、スティックが一つずつずれることを確認しています。
      *   また、その場合において、STARTとBACKがbumperに割り当てられていることを確認しています。

これらにおいて、修正方法を模索しています。現状刺した状態でコントローラーの判別を行うことは難しいと考えています。
おそらくボタンに数字が印字されているコントローラはある程度正常に動くのではと予想しています。
